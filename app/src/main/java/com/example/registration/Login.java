        ...
        else
        {
            ...
            mauth.signInWithEmailAndPassword(email,password)
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                       ...
                       {
                           SendUserToTheHomePage();
                           Toast.makeText(Login.this, "you are successfully Signed in", Toast.LENGTH_SHORT).show();
                           loadingBar.dismiss();
                       }
                       else
                       {
                           String message=task.getException().getMessage();
                           Toast.makeText(Login.this,"Error accured"+message,Toast.LENGTH_SHORT).show();
                           loadingBar.dismiss();
                       }
                        }
                    });
